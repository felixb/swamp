...
function swamp-team1-nonlive-readonly() {
  ...
  export AWS_PROFILE=team1-nonlive-readonly
}
...
function swamp-team1-nonlive-developer() {
  ...
  export AWS_PROFILE=team1-nonlive-developer
}
...
function swamp-team1-nonlive-admin() {
  ...
  export AWS_PROFILE=team1-nonlive-admin
}
...
function swamp-team1-live-readonly() {
  ...
  export AWS_PROFILE=team1-live-readonly
}
...
function swamp-team1-live-developer() {
  ...
  export AWS_PROFILE=team1-live-developer
}
...
function swamp-team1-infrastructure-readonly() {
  ...
  export AWS_PROFILE=team1-infrastructure-readonly
}
...
function swamp-team1-infrastructure-developer() {
  ...
  export AWS_PROFILE=team1-infrastructure-developer
}
...
function swamp-team2-nonlive-admin() {
  ...
  export AWS_PROFILE=team2-nonlive-admin
}
...
function swamp-team2-live-readonly() {
  ...
  export AWS_PROFILE=team2-live-readonly
}
...
function swamp-team2-infrastructure-readonly() {
  ...
  export AWS_PROFILE=team2-infrastructure-readonly
}
...
function swamp-team3-nonlive-developer() {
  ...
  export AWS_PROFILE=team3-nonlive-developer
}
...
function swamp-team3-nonlive-admin() {
  ...
  export AWS_PROFILE=team3-nonlive-admin
}
...
function swamp-team3-live-developer() {
  ...
  export AWS_PROFILE=team3-live-developer
}
...
function swamp-team3-live-admin() {
  ...
  export AWS_PROFILE=team3-live-admin
}
